...
class UserProfileController extends Controller
{
    ...
    public function user_update(Request $request)
    {
        $request->validate([
            ...
            'store_adress.required' => 'Store Adress is required',
        ]);
        if ($request->password) {
            $request->validate([
        ...
        if ($banner != null) 
        {
            $imageName = ImageManager::update('customer/banner/', auth('customer')->user()->image, 'png', $request->file('banner'));
            User::where('id', auth('customer')->id())->update(
            [
                'banner' => $imageName,
            ]);
        ...
        $secondary_banner = $request->file('secondary_banner');

        if ($secondary_banner != null) 
        {
            $imageName = ImageManager::update('customer/banner/', auth('customer')->user()->image, 'png', $request->file('secondary_banner'));
            User::where('id', auth('customer')->id())->update(
            [
                'secondary_banner' => $imageName,
            ]);
        }
        ...
        if ($logo != null) 
        {
            $imageName = ImageManager::update('customer/logo/', auth('customer')->user()->image, 'png', $request->file('logo'));
            User::where('id', auth('customer')->id())->update(
            [
                'logo' => $imageName,
            ]);
        ...
        if ($image1 != null) 
        {
            $imageName1 = ImageManager::update('profile/', auth('customer')->user()->image1, 'png', $request->file('image1'));
        } else 
        {
            $imageName1 = auth('customer')->user()->image1;
        }
        ...
        if ($image2 != null) 
        {
            $imageName2 = ImageManager::update('profile/', auth('customer')->user()->image2, 'png', $request->file('image2'));
        } else 
        {
            $imageName2 = auth('customer')->user()->image2;
        }
        ...
        if ($image3 != null) 
        {
            $imageName3 = ImageManager::update('profile/', auth('customer')->user()->image2, 'png', $request->file('image3'));
        } else 
        {
            $imageName3 = auth('customer')->user()->image3;
        }
