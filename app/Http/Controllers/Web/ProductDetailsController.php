...
class ProductDetailsController extends Controller
{
    ...
    public function theme_aster($slug)
    {
        ...
        if ($product != null) {
            ...
            if (isset(auth('customer')->user()->id)) 
            {
                $wishlistcategory = WishlistCategory::where('user_id',auth('customer')->user()->id)->get();
    
                return view(VIEW_FILE_NAMES['products_details'], compact('product','wishlistcategory', 'wishlist_status','countWishlist',
