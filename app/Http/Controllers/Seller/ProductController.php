...
class ProductController extends Controller
{
    public function add_new()
    {
        ...
        return view('seller-views.product.add-new', compact('cat', 'br', 'brand_setting', 'digital_product_setting','minimum_tax'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('seller-views.product.edit', compact('categories', 'br', 'product', 'product_category', 'brand_setting', 'digital_product_setting','minimum_tax'));
