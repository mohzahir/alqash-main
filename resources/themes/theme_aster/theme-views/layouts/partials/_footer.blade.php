            ...
            <div class="row gy-5">
                <div class="col-lg-4">
                    <div class="widget widget--about text-center text-lg-start absolute-white">
                        <img class="mb-3" style="max-width: 250px;min-width:250px" src="{{asset("storage/app/public/company/")}}/{{ $web_config['footer_logo']->value }}"
    ...
    <div class="footer-bottom absolute-white">
        <div class="container">
            <div class="text-center copyright-text">
                <a class="widget widget--nav absolute-white" href="https://www.tqniait.com/">
