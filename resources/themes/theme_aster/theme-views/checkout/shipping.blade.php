...
@push('script')
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key={{\App\CPU\Helpers::get_business_settings('map_api_key')}}&callback=mapsShopping&loading=async&libraries=places&v=3.49" defer></script>
