                        ...
                        <div class="col-lg-8 col-xl-7">
                            <form id="seller-registration" action="{{route('shop.apply')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="wizard">
                                    ...
                                    <h3>{{translate('Bank Info')}}</h3>
                                    <section>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-4">
                                                    <label for="holder_name">{{\App\CPU\translate('Holder_Name')}} *</label>
                                                    <input class="form-control" type="text" id="holder_name" name="holder_name" value="{{old('holder_name')}}" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group mb-4">
                                                    <label for="bank_name">{{\App\CPU\translate('Bank_Name')}} *</label>
                                                    <input class="form-control" type="text" id="bank_name" name="bank_name" value="{{old('bank_name')}}" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group mb-4">
                                                    <label for="branch">{{\App\CPU\translate('Branch_Name')}} *</label>
                                                    <input class="form-control" type="text" id="branch"  name="branch" value="{{old('branch')}}" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group mb-4">
                                                    <label for="account_no">{{\App\CPU\translate('Account_Number')}} *</label>
                                                    <input class="form-control" type="number" id="account_no" name="account_no" value="{{old('account_no')}}" required>
                                                </div>
                                            </div>
                                        </div>
                                    </section>
                                    <h3>{{translate('seller_company_info')}}</h3>
                                    <section>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-4">
                                                    <label for="storeName">{{translate('company_name')}} *</label>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-4">
                                                    <label for="storeAddress">{{translate('company_address')}} *</label>
                                            ...
                                            <div class="col-lg-6 mb-4">
                                                <div class="d-flex flex-column gap-3 align-items-center">
                                                    ...
                                                    <div class="text-center">
                                                        <h5 class="text-uppercase mb-1">{{translate('company_banner')}}</h5>
                                            ...
                                            <div class="col-lg-6 mb-4">
                                                <div class="d-flex flex-column gap-3 align-items-center">
                                                    ...
                                                    <div class="text-center">
                                                        <h5 class="text-uppercase mb-1">{{translate('company_commercial_id')}}</h5>
                                                        <div class="text-muted">{{translate('Image_Ratio')}} 3:1</div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6 mb-4">
                                                <div class="d-flex flex-column gap-3 align-items-center">
                                                    ...
                                                    <div class="text-center">
                                                        <h5 class="text-uppercase mb-1">{{translate('company_tax_card')}}</h5>
