                            ...
                            @foreach(json_decode($language) as $lang)
                                ...
                                if (count($product['translations'])) {
                                    ...
                                    foreach ($product['translations'] as $t) {
                                        ...
                                        if ($t->locale == $lang && $t->key == "disc") {
                                            $translate[$lang]['disc'] = $t->value;
                                        }
                                ...
                                <div class="{{$lang != 'en'? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                    ...
                                    <div class="form-group">
                                        <label class="title-color" for="{{$lang}}_disc">{{\App\CPU\translate('main_description')}}<span class="text-danger">*</span>
                                            ({{strtoupper($lang)}})</label>
                                        <input type="text" {{$lang == 'en'? 'required':''}} name="disc[]"
                                               id="{{$lang}}_disc"
                                               value="{{$translate[$lang]['disc']??$product['disc']}}"
                                               class="form-control" placeholder="{{\App\CPU\translate('New Product')}}" required>
                                    </div>
                    ...
                    <div class="card mt-2 rest-part">
                        ...
                        <div class="card-body">
                            <div class="row align-items-end">
                                ...
                                <!--<div class="col-md-4 form-group">-->
                                <!--    <label class="title-color">{{\App\CPU\translate('Commission')}} (%)</label>-->
                                <!--    <input type="number" min="0" max="100"-->
                                <!--            placeholder="{{\App\CPU\translate('Commission') }}"-->
                                <!--            name="commission" class="form-control"-->
                                <!--            value={{ \App\CPU\Convert::default($product->commission) }} required>-->
                                <!--</div>-->
                                <!--@endif-->
                                <div class="col-md-4 form-group">
                                ...
                                <div class="col-md-4 form-group">
                                    @php($min=\App\Model\BusinessSetting::where('type','min_commission')->first())
                                    <label class="title-color">{{\App\CPU\translate('Commission')}} (%) (min:{{intval($min->value)}})</label>
                                    <input type="number" min="{{$min->value}}" 
                                            placeholder="{{\App\CPU\translate('Commission') }}"
                                            name="commission" class="form-control"
                                            value="{{$product['commission'] ?? $min->value}}" 
                                            required>
                                </div>
