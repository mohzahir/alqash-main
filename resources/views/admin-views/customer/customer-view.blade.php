                            ...
                            <div class="card-body">
                                ...
                                <h4 class="mb-4 d-flex align-items-center gap-2">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="media-body d-flex flex-column gap-1">
                                        <span class="title-color">
                                            <strong>{{\App\CPU\translate('Store_Name')}} </strong>{{$customer['store_name']}}
                                        </span>
                                        <span class="title-color">
                                            <strong>{{\App\CPU\translate('Store_Adress')}} </strong>{{$customer['store_adress']}}
                                        </span>
                                        <span class="title-color">
                                            <strong>{{\App\CPU\translate('Store Type')}}</strong>{{$customer->type->name}} 
                                        </span>
                                        <span class="title-color">
                                            <strong>{{\App\CPU\translate('Stores Count')}} </strong>{{$customer['stores_count']}}
                                        </span>
                                    </div>
                                    <div class="media-body text-right">
                                        {{--<i class="tio-chevron-right text-body"></i>--}}
                                         ...
                                         <div class="media">
                                            <div class="mr-3">
                                                <img
                                                    class="avatar rounded-circle avatar-70"
                                                    onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                                    src="{{asset('public/storage/customer/banner/'.$customer->banner)}}"
                                                    alt="Image">
                                            </div>
                                            <div class="media-body d-flex flex-column gap-1">
                                                <span class="title-color hover-c1"><strong>{{translate('Store_Banner')}}</strong></span>
                                    ...
                                    <!--                class="avatar rounded-circle avatar-70"-->
                                    <!--                onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"-->
                                    <!--                src="{{asset('public/storage/customer/banner/'.$customer->secondary_banner)}}"-->
                                    <!--                alt="Image">-->
                                    <!--        </div>-->
                                    <!--        <div class="media-body d-flex flex-column gap-1">-->
                                    <!--            <span class="title-color hover-c1"><strong>{{translate('commercial_id')}}</strong></span>-->
                                    ...
                                    <!--                class="avatar rounded-circle avatar-70"-->
                                    <!--                onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"-->
                                    <!--                src="{{asset('public/storage/customer/logo/'.$customer->logo)}}"-->
                                    <!--                alt="Image">-->
                                    <!--        </div>-->
                                    <!--        <div class="media-body d-flex flex-column gap-1">-->
                                    <!--            <span class="title-color hover-c1"><strong>{{translate('tax_card')}}</strong></span>-->
                ...
                <div class="col-md-12 mt-2">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">{{\App\CPU\translate('company_commercial_id')}}</h5>
                        </div>
                        <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};" style="max-width:210px;min-width:210mm;max-height:297mm;min-height:297mm;">
                            <img class="upload-img-view upload-img-view__banner" id="viewer"
                            onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                            src="{{asset('public/storage/customer/banner/'.$customer->secondary_banner)}}" style="max-width:210px;min-width:210mm;max-height:297mm;min-height:297mm;" alt="Product thumbnail"/>
                        </div>
                    </div>
                </div>
                <div class="col-md-12 mt-2">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">{{\App\CPU\translate('company_tax_card')}}</h5>
                        </div>
                        <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};" style="max-width:210px;min-width:210mm;max-height:297mm;min-height:297mm;">
                            <img class="upload-img-view" id="viewer"
                            onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                            src="{{asset('public/storage/customer/logo/'.$customer->logo)}}" style="max-width:210px;min-width:210mm;max-height:297mm;min-height:297mm;" alt="Product thumbnail"/>
                        </div>
                    </div>
                </div>
