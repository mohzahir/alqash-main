...
@section('title', $seller->shop? $seller->shop->name : \App\CPU\translate("company_name"))
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="flex-between row mx-1">
                <div>
                    <h1 class="page-header-title">{{ $seller->shop? $seller->shop->name : "company_name : Update Please" }}</h1>
                </div>
            </div>
            <!-- Nav Scroller -->
                ...
                <ul class="nav nav-tabs flex-wrap page-header-tabs">
                    <li class="nav-item">
                        <a class="nav-link active"
                           href="{{ route('admin.sellers.view',$seller->id) }}">{{\App\CPU\translate('company')}}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link"
        ...
        <div class="row">
            ...
            @if($seller->shop)
                <div class="col-md-6 mt-2 mt-md-0">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">{{\App\CPU\translate('company')}} {{\App\CPU\translate('info')}}</h5>
                        </div>
                        <div class="card-body"
                             style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                            <div class="flex-start">
                            ...
                            <div class="flex-start">
                                <div><h5>{{\App\CPU\translate('Store Type')}} : </h5></div>
                                <div class="mx-1"><h5>{{$seller->shop->type->name ?? ''}}</h5></div>
                            </div>
                            <div class="flex-start">
                                <div><h5>{{\App\CPU\translate('Stores Count')}} : </h5></div>
                                <div class="mx-1"><h5>{{$seller->shop->stores_count}}</h5></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 mt-2">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">{{\App\CPU\translate('company_banner')}}</h5>
                        </div>
                        <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                            <img class="upload-img-view upload-img-view__banner" id="viewer"
                            onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                            src="{{asset('storage/app/public/shop/banner/'.$seller->shop->banner)}}"  alt="Product thumbnail"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12 mt-2">
                    <div class="card">
                        ...
                        <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};" style="max-width:210px;min-width:210mm;max-height:297mm;min-height:297mm;">
                            <img class="upload-img-view upload-img-view__banner" id="viewer"
                            onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                            src="{{asset('storage/app/public/shop/banner/'.$seller->shop->bottom_banner)}}" style="max-width:210px;min-width:210mm;max-height:297mm;min-height:297mm;" alt="Product thumbnail"/>
                        </div>
                    </div>
                </div>
                <div class="col-md-12 mt-2">
                    <div class="card">
                        ...
                        <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};" style="max-width:210px;min-width:210mm;max-height:297mm;min-height:297mm;">
                            ...
                            onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                            src="{{asset('storage/app/public/shop/'.$seller->shop->image)}}" style="max-width:210px;min-width:210mm;max-height:297mm;min-height:297mm;" alt="Product thumbnail"/>
                        </div>
                    </div>
                </div>
            @endif
