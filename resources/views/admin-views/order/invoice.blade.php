        ...
        <table class="customers bs-0">
            ...
            @foreach($order->details as $key=>$details)
                ...
                <tr>
                    ...
                    <td>{{\App\CPU\BackEndHelper::usd_to_currency($details['price']).' '.\App\CPU\BackEndHelper::currency_symbol()}} </td>
                    <td>{{$details->qty}}</td>
                    <td class="text-right">{{\App\CPU\BackEndHelper::usd_to_currency($subtotal).' '.\App\CPU\BackEndHelper::currency_symbol()}}</td>
                </tr>
                ...
                <table class="calc-table">
                    <tbody>
                        <tr>
                            ...
                            <td class="p-1">{{\App\CPU\BackEndHelper::usd_to_currency($sub_total).' '.\App\CPU\BackEndHelper::currency_symbol()}}</td>
                        </tr>
                        <tr>
                            <td class="p-1 text-left">{{\App\CPU\translate('tax')}}</td>
                            <td class="p-1">{{\App\CPU\BackEndHelper::usd_to_currency($total_tax).' '.\App\CPU\BackEndHelper::currency_symbol()}}</td>
                        </tr>
                        @if ($order->order_type=='default_type')
                            <tr>
                                <td class="p-1 text-left">{{\App\CPU\translate('shipping')}}</td>
                                <td class="p-1">{{\App\CPU\BackEndHelper::usd_to_currency($shipping).' '.\App\CPU\BackEndHelper::currency_symbol()}}</td>
                            </tr>
                        @endif
                        <tr>
                            <td class="p-1 text-left">{{\App\CPU\translate('coupon_discount')}}</td>
                            <td class="p-1">
                                - {{\App\CPU\BackEndHelper::usd_to_currency($order->discount_amount).' '.\App\CPU\BackEndHelper::currency_symbol()}} </td>
                        </tr>
                        @if ($order->order_type=='POS')
                            <tr>
                                <td class="p-1 text-left">{{\App\CPU\translate('extra_discount')}}</td>
                                <td class="p-1">
                                    - {{\App\CPU\BackEndHelper::usd_to_currency($ext_discount).' '.\App\CPU\BackEndHelper::currency_symbol()}} </td>
                            </tr>
                        @endif
                        <tr>
                            <td class="p-1 text-left">{{\App\CPU\translate('discount_on_product')}}</td>
                            <td class="p-1">
                                - {{\App\CPU\BackEndHelper::usd_to_currency($total_discount_on_product).' '.\App\CPU\BackEndHelper::currency_symbol()}} </td>
                        </tr>
                        <tr>
                            ...
                            <td class="border-dashed-top font-weight-bold">
                                {{\App\CPU\BackEndHelper::usd_to_currency($order->order_amount).' '.\App\CPU\BackEndHelper::currency_symbol()}}
                            </td>
                        </tr>
                    </tbody>
                </table>
