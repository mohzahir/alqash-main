    ...
    <div class="content container-fluid">
        ...
        <div class="row gy-3">
            ...
            <div class="col-md-6">
                <div class="card h-100">
                    <div class="card-header">
                        <h5 class="mb-0">{{\App\CPU\translate('min Commission')}}</h5>
                    </div>

                    <div class="card-body">
                        <form action="{{route('admin.business-settings.seller-settings.update-seller-min')}}"
                              method="post">
                            @csrf
                            <label class="title-color d-flex">{{\App\CPU\translate('min Commission')}} ( % )</label>
                            <input type="number" class="form-control" name="min_commission"
                                   value="{{isset($min)?$min->value:0}}" max="100" step="0.01">
                            <div class="mt-3 d-flex flex-wrap justify-content-end gap-10">
                                <button type="submit" class="btn btn--primary px-4">{{\App\CPU\translate('Save')}}</button>
                            </div>
                        </form>
