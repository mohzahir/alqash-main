            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            @php($minimum = \App\Model\BusinessSetting::where('type','minimum_tax')->first())
                            <div class="form-group">
                                <label
                                    class="input-label text-capitalize">{{\App\CPU\translate('Minimum tax')}}</label>
                                <input type="number" value="{{$minimum->value ?? ''}}"
                                       name="minimum_tax" class="form-control" min="0" max="100">
                            </div>
                        </div>
                    </div>
                </div>
