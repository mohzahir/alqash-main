                        ...
                        <div class="card-body">
                            @foreach (json_decode($language) as $lang)
                                <div class="{{ $lang != $default_lang ? 'd-none' : '' }} lang_form"
                                    ...
                                    <div class="form-group">
                                        <label class="title-color"
                                               for="{{ $lang }}_disc">{{ \App\CPU\translate('main_description') }}
                                            ({{ strtoupper($lang) }})
                                        </label>
                                        <input type="text" {{ $lang == $default_lang ? 'required' : '' }} name="disc[]"
                                               id="{{ $lang }}_disc" class="form-control" placeholder="New Product">
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" min="{{$minimum_tax}}" value="0" step="0.01"
