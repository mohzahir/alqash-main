                ...
                <div class="card-body p-sm-4">
                    <div class="row justify-content-between gy-4">
                            ...
                            <div class="bg-light p-3 p-sm-4 rounded h-100">
                                <div class="d-flex justify-content-center">
                                    <div class="ext-center">
                                        ...
                                        <p>{{translate('login_to_your_account.')}} {{translate('Don’t_have_account')}}                          
                                            <span
                        ...
                        <div class="col-lg-8 col-xl-7">
                            <form id="customer-registration" action="{{route('customer.auth.sign-up')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="wizard">
                                    <h3>{{translate('customer_Info')}}</h3>
                                    <section>
                                        <div class="row">
                                            <div class="col-lg-6">
                                            ...
                                            <div class="col-12">
                                                <div class="media gap-3 align-items-center">
                                                    ...
                                                    <div class="media-body d-flex flex-column gap-1 upload-img-content">
                                                        <h5 class="text-uppercase mb-1">{{translate('Customer_Image')}}</h5>
                                    ...
                                    <h3>{{translate('customer_company_info')}}</h3>
                                    <section>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-4">
                                                ...
                                                <div class="row py-2 mt-4">
                                                    ...
                                                    <div class="col-6 input-icons mb-2 rounded bg-white">
                                                        <a onclick="re_captcha_customer_regi();" class="d-flex align-items-center align-items-center">
                                                            <img src="{{ URL('/seller/auth/code/captcha/1?captcha_session_id=default_recaptcha_id_customer_regi') }}" class="input-field rounded __h-40" id="customer_regi_recaptcha_id">
...
@if($web_config['recaptcha']['status'] == '1')
    <script>
        var onloadCallback = function () {
            let reg_id = grecaptcha.render('recaptcha_element_customer_regi', {'sitekey': '{{ \App\CPU\Helpers::get_business_settings('recaptcha')['site_key'] }}'});
    ...
    <script>
        ...
        form.children(".wizard").steps({
            ...
            onFinished: function (event, currentIndex)
            {
                @if($web_config['recaptcha']['status'] == '1')
                    if(currentIndex > 0){
                        var response = grecaptcha.getResponse($('#recaptcha_element_customer_regi').attr('data-reg-id'));
