                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if(\App\CPU\Helpers::module_permission_check('product_management'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/store-type*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.store-type.view')}}"
                                   title="{{\App\CPU\translate('Store Type')}}">
                                    <i class="tio-category-outlined nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{\App\CPU\translate('Store Type')}}</span>
                                </a>
                            </li>
                        @endif
                                ...
                                <li class="nav-item {{Request::is('admin/report/inhoue-product-sale')?'active':''}}">
                                    <a class="nav-link" href="{{route('admin.report.inhoue-product-sale')}}"
                                       title="{{\App\CPU\translate('inhouse')}} {{\App\CPU\translate('sales')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">
                                        {{\App\CPU\translate('inhouse sales')}}
                                    </span>
                                    </a>
                                </li>
