...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'store-type', 'as' => 'store-type.'], function () {
            Route::get('view', 'StoreTypeController@index')->name('view');
            Route::get('fetch', 'StoreTypeController@fetch')->name('fetch');
            Route::post('store', 'StoreTypeController@store')->name('store');
            Route::get('edit/{id}', 'StoreTypeController@edit')->name('edit');
            Route::post('update/{id}', 'StoreTypeController@update')->name('update');
            Route::post('delete', 'StoreTypeController@delete')->name('delete');
        });
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
            ...
            Route::group(['prefix' => 'seller-settings', 'as' => 'seller-settings.','middleware'=>['module:system_settings']], function () {
                ...
                Route::post('update-seller-min', 'BusinessSettingsController@min_commission')->name('update-seller-min');
