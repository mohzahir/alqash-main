...
Route::group(['namespace' => 'api\v1', 'prefix' => 'v1', 'middleware' => ['api_lang']], function () 
{
    ...
    Route::get('store-types', 'CustomerController@storeTypes');
    ...
    Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () 
    {
        ...
        Route::group(['prefix' => 'wish-list'], function () 
        {
         ...
         Route::group(['prefix' => 'category_wishlist'], function () 
        {
            Route::get('/', 'CustomerController@categories_wishlist');
            Route::post('add', 'CustomerController@add_category_to_wishlist');
            Route::put('update', 'CustomerController@update_category_to_wishlist');
            Route::delete('remove', 'CustomerController@remove_from_category_wishlist');
        });
    ...
    Route::post('/initiate-payment', [App\Http\Controllers\QibController::class, 'initiatePaymentAPI']);
