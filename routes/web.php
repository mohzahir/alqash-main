...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode']], function () {
    ...
    Route::get('chat-for-product', 'WebController@chat_for_product')->name('chat-for-product');
         ...
         Route::post('storeCategoryWishlist', [wishlistCategoryController::class, 'storeCategoryWishlist'])->name('storeCategoryWishlist')->middleware('customer');
         Route::put('updateCategoryWishlist', [wishlistCategoryController::class, 'updateCategoryWishlist'])->name('updateCategoryWishlist')->middleware('customer');
         Route::post('deleteCategoryWishlist', [wishlistCategoryController::class, 'deleteCategoryWishlist'])->name('deleteCategoryWishlist')->middleware('customer');
         Route::get('showCustomerFolders', [wishlistCategoryController::class, 'showCustomerFolders'])->name('showCustomerFolders')->middleware('customer');
...
Route::get('/qib/callback', 'QibController@callback')->name('qib_callback');
